...
{% picture /assets/images/20220915105932_00047_St_Marks_Square_clock_tower_Venice_view_from_above_flooded_disaster_water_from_the_sea.png --alt Venice as we imagine it %}

{% picture /assets/images/20220915120821_00002_Venice_destroyed_by_a_nuclear_bomb.png --alt Venice after being destroyed by an atomic bomb %}

{% picture /assets/images/20221005064139_00001_looking_down_at_the_colosseum_with_gladiators_fighting.png --alt The ruins of the Colosseum in Rome %}

{% picture /assets/images/20221005081530_00010_looking_down_at_ground_zero_destruction_world_trade_center_remains_of_south_tower__the_pile_photograph_by_joel_meyerowitz.png --alt Ground Zero in New York City %}

{% picture /assets/images/20221005085340_00001_looking_down_at_Surface_mining_including_strip_mining_openpit_mining_landscape.png --alt A strip mine %}

{% picture /assets/images/20221005090947_00002_a_refugee_camp_for_Syrian_refugees_aerial_view.png --alt A refugee camp %}

{% picture /assets/images/20221005092640_00001_looking_down_at_the_three_gorges_dam_dry_riverbed.png --alt A massive dam construction project %}

{% picture /assets/images/20221005093243_00001_looking_down_on_a_scrap_yard_filled_with_old_cars.png --alt A scrap yard %}

{% picture /assets/images/20220915125115_00019_looking_down_at_the_tate_modern_turbine_hall_filled_with_sand.png --alt A contemporary art exhibition hall %}

{% picture /assets/images/20220915123853_00000_museum_exhibition_huge_mural_on_the_wall_beach_scene_aerial_view.png --alt A beach resort %}
