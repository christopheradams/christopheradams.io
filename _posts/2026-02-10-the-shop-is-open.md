...
[^nfts]: You might ask, *why not use a blockchain for this?* An [NFT] contract
    *can* correlate a work's ownership, data, and image. However, I'm following
    an another tradition, where the artist--collector bond is much more than an
    entry in a distributed ledger. In short, these works are not just *tokens.*
